...
`arcanum.svg` (used by the Browse the Arcana macro) is the project's own redrawing of the triple
spiral the rulebooks stamp beside an arcanum — a larger-marked copy of `assets/icons/arcanum.svg`.
Neither is a game-icons.net asset, so neither is listed above.
