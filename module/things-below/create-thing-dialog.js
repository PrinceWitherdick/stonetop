...
const _STEPS = [
	...
	},
	{
		...
		isFinal: true,
		body:    `<p>Look it over. Its card goes to the homebrew Threats journal; drag it onto the Stonetop steading sheet's Threats tab to make it a live, revealable threat.</p>`,
	},
];
