...
export function onUpdateCondemned(actor, changed) {
	...
	// ⚠ BRACKETS off SYSTEM_ID, never a dotted path. This package's id happens to be
	...
	// subtraction and throws at runtime. Same trap ActorDirectoryNames.js documents.
