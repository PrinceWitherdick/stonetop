...
const _STEPS = [
	...
	},
	{
		...
		isFinal: true,
		body:    `<p>Look it over. Its card lives on the steading sheet beside your threats: reveal it to the players with the eye, drag it onto a scene to pin it to the map, and edit it any time.</p>`,
	},
];
