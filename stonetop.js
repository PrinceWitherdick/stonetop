...
Hooks.once("init", () => {
	...
	game.stonetop.templatesReady = loadTemplates({
		...
		"stonetop.condemned-tag":     "systems/stonetop_pwd/templates/actor/partials/condemned-tag.hbs",
		...
		"stonetop.tab-timeline":        "systems/stonetop_pwd/templates/actor/partials/tab-timeline.hbs",
		...
		"stonetop.relationship-map":       "systems/stonetop_pwd/templates/dialogs/relationship-map.hbs",
		"stonetop.relationship-map-board": "systems/stonetop_pwd/templates/dialogs/partials/relationship-map-board.hbs",
		"stonetop.intro-match":            "systems/stonetop_pwd/templates/dialogs/intro-match.hbs",
		"stonetop.person-picker":          "systems/stonetop_pwd/templates/dialogs/person-picker.hbs",
		// Rendered by BOTH Death's Door's last step and the standalone Post-Death chooser.
		"stonetop.post-death-choices":   "systems/stonetop_pwd/templates/dialogs/partials/post-death-choices.hbs",
		...
		"stonetop.steading-tab-relmap":       "systems/stonetop_pwd/templates/actor/partials/steading-tab-relmap.hbs",
		"stonetop.steading-tab-timeline":     "systems/stonetop_pwd/templates/actor/partials/steading-tab-timeline.hbs",
		"stonetop.steading-tab-notes":        "systems/stonetop_pwd/templates/actor/partials/steading-tab-notes.hbs",
		"stonetop.gm-toolkit-tab-moves":      "systems/stonetop_pwd/templates/actor/partials/gm-toolkit-tab-moves.hbs",
		"stonetop.gm-toolkit-tab-loop":       "systems/stonetop_pwd/templates/actor/partials/gm-toolkit-tab-loop.hbs",
		"stonetop.gm-toolkit-tab-threats":    "systems/stonetop_pwd/templates/actor/partials/gm-toolkit-tab-threats.hbs",
		// Not a tab any more: a folded section at the foot of the Expeditions panel.
		"stonetop.gm-toolkit-sites-section": "systems/stonetop_pwd/templates/actor/partials/gm-toolkit-sites-section.hbs",
		...
		"stonetop.gm-toolkit-tab-expeditions": "systems/stonetop_pwd/templates/actor/partials/gm-toolkit-tab-expeditions.hbs",
		...
		"stonetop.gm-expedition-card":        "systems/stonetop_pwd/templates/actor/partials/gm-expedition-card.hbs",
		...
		"stonetop.gm-prep-guide-items":       "systems/stonetop_pwd/templates/actor/partials/gm-prep-guide-items.hbs",
		...
		"stonetop.site-page":                 "systems/stonetop_pwd/templates/journal/site-page.hbs",
		"stonetop.site-card":                 "systems/stonetop_pwd/templates/journal/partials/site-card.hbs",
		...
		"stonetop.guide-tabs":                "systems/stonetop_pwd/templates/dialogs/partials/guide-tabs.hbs",
		...
		"stonetop.header-count-glyph":        "systems/stonetop_pwd/templates/actor/partials/header-count-glyph.hbs",
		"stonetop.card-head":                 "systems/stonetop_pwd/templates/journal/partials/card-head.hbs",
...
// spells `game.settings.set("stonetop_pwd", …)` — so nothing of ours stops being caught.
