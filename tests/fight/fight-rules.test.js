...
// (pdftotext -enc UTF-8, printed pages 414 to 418), punctuation included.
...
const PRINTED = {
	...
	smallerEngagements: [414, "This isn’t anything formal."],
	...
	noTurns: [417, "Players shouldn’t get bored waiting for “their turn,”"],
	mapsFocus: [418, "Use the map to visualize and communicate, but keep the focus on the conversation."],
};
...
describe("FIGHT_RULES", () => {
	...
	it("marks the GM's advice as the GM's", () => {
		...
		expect(gmOnly).toEqual(["engagesMultiple", "mapsFocus", "smallerEngagements", "unengagedFoes"]);
	});
